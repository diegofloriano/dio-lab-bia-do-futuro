...
> Me ajude a:
> (1) entender o que cada arquivo contem,
...
| Arquivo | Formato | Para que serve no Léo? |
|---------|---------|---------------------|
...
| `transacoes.csv` | CSV | Analisar padrão de gastos do cliente e utilizar essas informações de forma didática |
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim poderei validar as respostas do Leo de forma mais assertiva.
---
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "Dividend Yield (DY) fica entre 6% a 12% ao ano",
    "aporte_minimo": 100.00,
